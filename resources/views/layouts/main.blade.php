    ...
    <body class="bg-gray-100">
            ...
            <nav class="bg-white shadow-md p-4 flex justify-between items-center">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <img src="https://via.placeholder.com/40" alt="User" class="w-10 h-10 rounded-full border border-gray-300">
                </div>
            </nav>
            ...
            <div class="flex">
                ...
                <!-- <aside id="sidebar" class="bg-gray-900 text-white w-64 min-h-screen p-4 transition-all duration-300">
                    <button id="toggleSidebar" class="text-white mb-4">
                        <i class="ph ph-list text-2xl"></i>
                    </button>
                    <ul class="space-y-4">
                        <li class="p-3 bg-gray-800 rounded hover:bg-gray-700"><a href="#" class="flex items-center"><i class="ph ph-house mr-2"></i> Dashboard</a></li>
                        <li class="p-3 bg-gray-800 rounded hover:bg-gray-700"><a href="#" class="flex items-center"><i class="ph ph-users mr-2"></i> Users</a></li>
                        <li class="p-3 bg-gray-800 rounded hover:bg-gray-700"><a href="#" class="flex items-center"><i class="ph ph-gear mr-2"></i> Settings</a></li>
                    </ul>
                </aside> -->
